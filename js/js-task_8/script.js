...
let author = doc.createElement("meta");
author.setAttribute("name","author");
author.setAttribute("content","O.Ignatuk");
...
let section = doc.createElement("section");
section.classList.add("creator");
let containerCreator = containerHeader.cloneNode();

let creatorWrapper = doc.createElement("div");
...
let pCreator = doc.createElement("p");
pCreator.innerHTML = "But I must explain to you how all this mistaken idea of denouncing";

let button = doc.createElement("button");
button.classList.add("button");
button.innerHTML = "START HER";

creatorBlock.append(creatorName);
creatorBlock.append(h2);
creatorBlock.append(pCreator);
creatorBlock.append(button);
...
creatorWrapper.append(creatorBlock);
creatorWrapper.append(creatorBlock2);
containerCreator.append(creatorWrapper);
section.append(containerCreator);
